...
module.exports = {
    ...
    fr: {
        translation: {
            ...
            SHORT_HELP_MSG: 'Dites-moi \'enregistre ma date de naissance\' pour que je m\'en rappelle et \'combien de jours reste-t-il avant mon anniversaire\' pour savoir le temps restant avant de l\'arroser! ',
            ...
            LIST_PERSON_DETAIL_MSG: `{{person.humanLabel.value}} est né le {{person.date_of_birth.value}} à <lang xml:lang="en-US">{{person.place_of_birthLabel.value}}</lang>. `
        }
    },
    "fr-CA" : {
        translation: {
